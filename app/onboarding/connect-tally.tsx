      ...
      <Nav
        rightSlot={
          <View className="flex-row items-center gap-2">
            <View className="w-8 h-8 rounded-full bg-brand-tint items-center justify-center">
              <Text className="text-xs font-semibold text-ink-tertiary">HS</Text>
            </View>
            <Text className="text-sm text-slate-700 font-medium">Harsh</Text>
          </View>
        }
      />
      <ScrollView contentContainerClassName="pb-20">
        <View className="w-full self-center px-6 pt-14" style={{ maxWidth: 720 }}>
          ...
          <Text
            ...
            style={{ fontSize: 40, lineHeight: 46, letterSpacing: -0.75 }}
          >
...
function DesktopPane() {
  return (
    <View className="gap-5">
      <View className="bg-surface border border-slate-200 rounded-2xl px-6">
        <Row num={1} title="Download the Riko Connector">
          ...
          <View className="flex-row gap-2.5 mt-3 flex-wrap">
            <Pressable className="flex-row items-center gap-2 bg-ink rounded-full px-5 py-2.5">
              <Download size={14} color="#ffffff" strokeWidth={2.25} />
              <Text className="text-sm font-semibold text-white">Download for Windows</Text>
            </Pressable>
            <Pressable className="border border-slate-300 rounded-full px-5 py-2.5 bg-surface">
        ...
        <Row num={2} title="Sign in inside the Connector">
          ...
          <View className="self-start mt-3 bg-slate-100 px-4 py-2.5 rounded-lg">
            <Text
  ...
  return (
    <View className="gap-5">
        ...
        <Row num={1} title="Send the install link to your laptop">
          ...
          <View className="flex-row gap-2 mt-3">
            <TextInput
              ...
              className="flex-1 px-4 py-2.5 border border-slate-300 rounded-lg bg-surface text-sm text-ink"
      ...
      <View className="items-center">
        <Pressable className="flex-row items-center gap-2 bg-amber-600 rounded-full px-5 py-3">
