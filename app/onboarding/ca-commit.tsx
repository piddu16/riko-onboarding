...
import { useOnboarding, topCaIntent, type Commitment } from "@/lib/onboarding-store";
import { CA_INTENT_VERB } from "@/lib/ca-content";
...
export default function CaCommit() {
  ...
  const verb = CA_INTENT_VERB[intent];
    ...
    <View className="flex-1 bg-surface">
      ...
      <ScrollView contentContainerClassName="pb-24">
        <View className="w-full self-center px-5" style={{ maxWidth: 640, paddingTop: compact ? 24 : 56 }}>
          ...
          >
            How important is {verb} to your practice in the next 30 days?
          </Text>
