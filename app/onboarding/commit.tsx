...
import { useOnboarding, topIntent, type Commitment } from "@/lib/onboarding-store";
import { INTENT_VERB } from "@/lib/onboarding-content";
...
const OPTIONS: Array<{ key: Commitment; label: string; note: string }> = [
  ...
  { key: "very", label: "Very important", note: "A priority in the next quarter." },
  { key: "somewhat", label: "Somewhat important", note: "On my list but not urgent." },
